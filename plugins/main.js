...
_*This queen sithu whatsapp bot is made for your easy use. This bot is currently active🪄*_
...
> *𝐐𝐔𝐄𝐄𝐍 𝐒𝐈𝐓𝐇𝐔 𝐌𝐃*`;
        ...
        const vv = await conn.sendMessage(from, { image: { url: "https://files.catbox.moe/zuufwh.jpg"}, caption: desc }, { quoted: mek });
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        const botStatus = `*QUEEN SITHU MD*
